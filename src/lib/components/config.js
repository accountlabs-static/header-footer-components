export const ProductsConfigProduct = {
  k3Pro: {
    ...
    variantId: 'gid://shopify/ProductVariant/43296530301081',
    variants: [
      {
        name: 'pontem',
        id: 'gid://shopify/Product/7699978125465',
      },
      {
        name: 'dodo',
        id: 'gid://shopify/Product/7698545246361',
      },
      {
        name: 'alienswap',
        id: 'gid://shopify/Product/7698543411353',
      },
      {
        name: 'solflare',
        id: 'gid://shopify/Product/7682718957721',
      },
      {
        name: 'woofi2',
        id: 'gid://shopify/Product/7700040155289',
      },
      {
        name: 'woofi',
        id: 'gid://shopify/Product/7699978584217',
      },
      {
        name: 'shardeum',
        id: 'gid://shopify/Product/7698549768345',
      },
      {
        name: 'blockwallet',
        id: 'gid://shopify/Product/7699978813593',
      },
      {
        name: 'haqq',
        id: 'gid://shopify/Product/7699978616985',
      },
      {
        name: 'cowswap',
        id: 'gid://shopify/Product/7699978715289',
      },
      {
        name: 'metamask',
      ...
      {
        name: 'slowmist',
        id: 'gid://shopify/Product/7702042312857',
      },
      {
        name: 'okx',
        id: 'gid://shopify/Product/7706309820569',
      },
      {
        name: 'safe',
        id: 'gid://shopify/Product/7733320515737',
      },
      {
        name: 'orderly-network',
        id: 'gid://shopify/Product/7751935525017',
      },
      {
        name: 'istanbul-dev-connect',
        id: 'gid://shopify/Product/7761378967705',
      },
      {
        name: 'ghostlab',
        id: 'gid://shopify/Product/7778114011289',
      },
      {
        name: 'custom',
        id: 'gid://shopify/Product/7763118424217',
      },
      {
        name: 'platon',
        id: 'gid://shopify/Product/7818871013529',
      },
    ],
  },
  k3Pro6thAnniversary: {
...
export const LINKS = {
  ...
  shop: `${DOMAIN}/shop`,
  shopProducts: {
    k3: `${DOMAIN}/shop/products/keystone-3`,
    k3Pro: `${DOMAIN}/shop/products/keystone-3pro`,
    k3ProBundlePack: `${DOMAIN}/shop/products/keystone-3pro-bundle-pack`,
    k3ProOkx: `${DOMAIN}/shop/products/keystone-3pro-okx`,
    tablet: `${DOMAIN}/shop/products/keystone-tablet`,
  },
  githubRepo: 'https://github.com/KeystoneHQ',
  githubGen3Firmware: 'https://github.com/KeystoneHQ/keystone3-firmware',
  shippingRegions: `${DOMAIN}/shipping-regions`,
  supportAssetsAndWallets: `${DOMAIN}/supported-wallets-and-assets`,
  salesTermsAndConditions: `${DOMAIN}/sales-terms-and-conditions`,
  termsOfUse: `${DOMAIN}/website-terms-of-use`,
  keystoneTermsOfUse: `${DOMAIN}/keystone-terms-of-use`,
  privacyPolicy: `${DOMAIN}/privacy-policy`,
  cookiePolicy: `${DOMAIN}/cookie-policy`,
  shippingPolicy: `${DOMAIN}/shipping-policy`,
  refundPolicy: `${DOMAIN}/refund-policy`,
  resellars: `${DOMAIN}/resellers`,
  affiliates: `${DOMAIN}/affiliates`,
  bugBountyProgram: `${DOMAIN}/bug-bounty-program`,
  whyKeystone: `${DOMAIN}/why-keystone`,
  expertReviews: `${DOMAIN}/expert-reviews`,
  web3Compatible: `${DOMAIN}/web3-compatible`,
  securitySchemes: `${DOMAIN}/security-schemes`,
  firmware: `${DOMAIN}/firmware`,
  metamask: `${DOMAIN}/metamask`,
  usbUpgrade: `${DOMAIN}/usb-upgrade`,
  btcOnly: `${DOMAIN}/btc-only`,
  nft: `${DOMAIN}/nft`,
  ...
  okx: `${DOMAIN}/okx`,
  okxCollabs: `${DOMAIN}/okx-collabs`,
  blog: {},
  coBranded: `${DOMAIN}/co-branded`,
  roadmap: `${DOMAIN}/roadmap`,
  officialSite: 'https://keyst.one',
  getStarted: `${DOMAIN}/get-started`,
  authentication: `${DOMAIN}/authentication`,
  tutorial: `https://guide.keyst.one/`,
}
